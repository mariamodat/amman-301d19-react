...
// sutend as an objects of the constructor function.
//
// 2. What is "this" when joe.scopeArrow() is invoked?
//window if we used the arrow function !
// 3. Explain why "this" is different when an arrow function is used.
// because we cant't use this in the arrow function
// Arrow functions and this. In classic function expressions, the this keyword
// is bound to different values based on the context in which the function is called. 
//Whereas arrow functions use the value of this in their lexical scope. This leads to very 
//different behaviour.